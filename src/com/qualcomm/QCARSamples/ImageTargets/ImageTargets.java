...
public class ImageTargets extends Activity
{
    ...
    {
        mTextures.add(Texture.loadTextureFromApk("money.jpg",
                                                 getAssets()));
        mTextures.add(Texture.loadTextureFromApk("flower.png",
                                                 getAssets()));
        mTextures.add(Texture.loadTextureFromApk("money.jpg",
                getAssets()));        
    }
    ...
    private class AccountManagerObserver extends DataSetObserver {
		...
		public void onChanged() {
			ImageTargets.user= accountManager.getUsername();	
		}
	}
 ...
 //MB
        ImageTargetsRenderer.mainActivityHandler = new Handler() {
        	...
        	public void handleMessage(Message msg){
        		...
        		//Looper.prepare();
        		DebugLog.LOGD("intending intent");
        		Context context = getApplicationContext();
            	String text = ImageTargets.user + "Here's Your Flower.\n Thank you for giving " + "1" + " dollar!" ;
            	//String text = "hello!!";
...
/*        		 
        		...
        		String trackable = (String) msg.obj;
        		loadArt(getFrame()); 
        		*/
        	}
		};
